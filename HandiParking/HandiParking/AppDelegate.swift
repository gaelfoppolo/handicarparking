...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    // pour faire les appels serveurs Google Maps
    let cleAPIGoogleMapsServeur = "AIzaSyB5wnwkYNT7azlLkIGDOcFAA3DrBo-Jneo"
    // pour afficher la carte dans l'application
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.keepcore.HandiParking" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("HandiParking", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
        ...
        let url = self.applicationDocumentsDirectory.URLByAppendingPathComponent("HandiParking.sqlite")
